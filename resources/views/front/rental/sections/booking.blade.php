        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="stepone">
                    <div class="booking-card">
                        ...
                        <div class="justify-content-between">
                            <div class="booking-box-2 bg-ter">
                                ...
                                <div class="mb-32 d-flex justify-content-between flex-md-row flex-column">
                                    <div class="gap-32 d-flex">
                    ...
                    <div class="py-40 mt-32 booking-card-2">
                    ...
                    <div class="py-40 mt-32 booking-card-3">
                        ...
                        <div class="gap-12 mb-24 checkbox d-flex">
                    ...
                    <div class="mb-12 text-end">
                        <button type="button" class="mt-24 cus-btn bookingProcced">
                            <span class="btn-text">
                                Procced to Payment
                            </span>
                            <span>
                ...
                <div class="steptwo">
                    ...
                    <div class="mt-32 booking-card-4 bg-ter">
                        <h5 class="mb-24">When would you like to pay?</h5>
                        <div class="gap-12 mb-24 d-flex">
                            <div>
                    ...
                    <form method="post" class="car-booking-form">
                        <div class="mt-24 booking-card-5 bg-ter">
                            <h5 class="mb-24">How would you like to pay?</h5>
                            <div class="row-gap-3 row">
                                <div class="col-lg-6">
                                    <div class="card">
                                        <div class="gap-12 d-flex align-items-center justify-content-center">
                        ...
                        <div class="text-end">
                            <button type="submit" class="mt-24 mb-16 cus-btn">
                                <span class="btn-text">
                                    Complete Booking
                                </span>
                                <span>
            ...
            <div class="col-lg-4">
                <div class="side-bar">
                    ...
                    <div class="vehicle-details-2 bg-ter">
                        ...
                        <div class="mb-24 d-flex justify-content-between flex-xl-row flex-column flex-end">
                            <img src="{{ asset('front/assets/media/cars/Car-image.png')}}" alt="Car">
                            <div class="gap-8 icons d-flex align-items-end">
                        ...
                        <div class="gap-8 mb-12 d-flex align-items-center">
                            ...
                            <div id="faq1" class="accordion-collapse collapse show" aria-labelledby="faq1"
                                ...
                                <div class="gap-8 d-flex">
                                    ...
                                    <div class="block">
                                        ...
                                        <p class="mb-32 light-gray">Meet & Greet</p>
                                    </div>
                                </div>
                                <div class="gap-8 d-flex">
                                    <div>
                                    ...
                                    <div class="block">
                                        <p>Fuel Policy:</p>
                                        <p class="mb-32 light-gray">Full to Full</p>
                                    </div>
                                </div>
                                <div class="gap-8 d-flex">
                                    <div>
                ...
                <div class="mt-32 side-bar">
                    <div class="vehicle-details bg-quant">
                        <h4>Price Summary</h4>
                    </div>
                    <div class="vehicle-details-2 bg-ter">
                        <div class="mb-24 justify-content-between d-flex">
                            <div>
                                <h6>Car Hire Fee</h6>
                        ...
                        <hr class="mb-12 color-primary">
                        <div class="mb-32 justify-content-between d-flex">
                            <div>
                                <h6>Deal / Discount</h6>
                            </div>
                            <h6>$ 40</h6>
