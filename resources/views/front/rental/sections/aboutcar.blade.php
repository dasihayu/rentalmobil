<section class="details py-80">
    <div class="container-fluid">
        <div class="row-gap-4 row">
            <div class="col-lg-8">
                <div class="mt-48 slider-arrows smt-sm-0 d-sm-flex">
                    <a>
            ...
            <div class="col-lg-4">
                <div class="sides-bar">
                    <div class="mb-16 side-bar-1">
                        <div class="gap-4 mb-16 d-flex align-items-center">
                ...
                <div class="mt-24 side-bar-2">
                    <div class="form">
                        ...
                        <input type="text" class="mb-12" placeholder="Brook Field St, Newark, USA ">
                        <p class="mb-8 fw-600 dark-gray">Pick-Up Date</p>
                        ...
                        <p class="mb-8 fw-600 dark-gray">DROP-OFF-date</p>
                        <div class="gap-24 d-flex">
                            <input type="text" class="mb-12" placeholder="June 11, 2024 ">
                            <input type="text" class="mb-12" placeholder="11: 00 AM">
                        </div>
