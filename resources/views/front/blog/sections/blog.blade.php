<div class="blogs my-80">
        <div class="container-fluid">
            <div class="mb-24 d-lg-flex justify-content-between">
                <ul class="gap-12 mb-3 nav unstyled nav-pills d-flex" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="pills-recommended-tab" data-bs-toggle="pill" 
                            data-bs-target="#pills-recommended" type="button" role="tab" aria-controls="pills-recommended"
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4">
                            <div class="blog-card">
                                ...
                                <div class="text-block">
                                    ...
                                    <a href="{{ route('blog.detail') }}" class="mb-16 title">Navigating the Rental Market: Essential and Essential  Don'ts...
                                    </a>
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="blog-card">
                                ...
                                <div class="text-block">
                                    <p class="mb-12">April 7, 2024</p>
                                    <a href="blogs.html" class="mb-16 title">EcoTenant Troubles? Mastering  in  for Rental
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="blog-card">
                                ...
                                <div class="text-block">
                                    <p class="mb-12">April 7, 2024</p>
                                    <a href="blogs.html" class="mb-16 title">The Art of Home Staging: Transforming Spaces to Tenants...</a>
                                    <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                        nascetur
                                        ipsum .</p>
                                    <a href="{{ route('blog.detail') }}" class="cus-btn-2">
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="blog-card">
                                ...
                                <div class="text-block">
                                    <p class="mb-12">April 7, 2024</p>
                                    <a href="blogs.html" class="mb-16 title">Rental Renovation: Smart Upgrades Add Value and
                                        Charm...
                                    </a>
                                    <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                        nascetur
                        ...
                        <div class="col-lg-4 col-md-4">
                            <div class="blog-card">
                                ...
                                <div class="text-block">
                                    <p class="mb-12">April 7, 2024</p>
                                    <a href="blogs.html" class="mb-16 title">The Art of Home Staging: Transforming Spaces to Tenants..
                                    </a>
                                    <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                        nascetur
                                        ipsum .</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-card">
                                ...
                                <div class="text-block">
                                    <p class="mb-12">April 7, 2024</p>
                                    <a href="blogs.html" class="mb-16 title">EcoTenant Troubles? Mastering Resolution in Rental
                                        Properties...</a>
                                    <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                        nascetur
                                        ipsum .</p>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-card">
                                ...
                                <div class="text-block">
                                    <p class="mb-12">April 7, 2024</p>
                                    <a href="blogs.html" class="mb-16 title">Eco-Friendly Rentals: Sustainability Solutions for Property
                                        Owners...</a>
                                    <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                        nascetur
                                        ipsum .</p>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-card">
                                ...
                                <div class="text-block">
                                    <p class="mb-12">April 7, 2024</p>
                                    <a href="blogs.html" class="mb-16 title ">The Rise of Remote Work: Rental Properties for the Digital
                                        Nomad...
                                    </a>
                                    <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                        nascetur
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-card">
                                ...
                                <div class="text-block">
                                    <p class="mb-12">April 7, 2024</p>
                                    <a href="blogs.html" class="mb-16 title">Pets Welcome! Creating Pet-Friendly Environments...</a>
                                    <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                        nascetur
                                        ipsum .</p>
                                    <a href="{{ route('blog.detail') }}" class="cus-btn-2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="blog-card">
                                ...
                                <div class="text-block">
                                    <p class="mb-12">April 7, 2024</p>
                                    <a href="{{ route('blog.detail') }}" class="mb-16 title">Pets Welcome! Creating Pet-Friendly Environments in Rental
                                        Homes...
                                    </a>
                                    <p class="mb-24">Lorem ipsum dolor sit amet consectetur. Ac nisl lacus fermentum sollicitudin
                                        nascetur
