                ...
                <div class="card-body">
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div id="features-container">
                            <div class="form-group">
                                <input type="text" class="mb-1 form-control" placeholder="Enter car feature">
                            </div>
                        </div>
                        ...
                        <div id="extra-services-container">
                            <div class="form-group">
                                <input type="text" class="mb-1 form-control" placeholder="Enter extra service">
                            </div>
                        </div>
                        ...
                        <button type="submit" class="mt-3 btn btn-primary">Add Car</button>
                    </form>
                </div>
            </div>
        </div>
