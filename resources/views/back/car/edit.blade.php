                ...
                <div class="card-body">
                    <form action="#" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" class="form-control" id="name" value="Toyota Corolla"
                                required>
                        </div>
                        <div class="form-group">
                        ...
                        <div id="features-container">
                            <div class="form-group feature-item">
                                <input type="text" name="car_features[]" class="mb-1 form-control"
                        ...
                        <button type="button" id="add-feature" class="mb-5 btn btn-secondary">Add Feature</button>

                        <h5>Extra Services</h5>
                        <div id="extra-services-container">
                            <div class="form-group extra-service-item">
                                <input type="text" name="extra_services[]" class="mb-1 form-control" value="Driver"
                                    placeholder="Enter extra service">
                                <button type="button" class="btn btn-danger btn-sm remove-extra-service">Remove</button>
                            </div>
                        </div>
                        <button type="button" id="add-extra-service" class="mb-5 btn btn-secondary">Add Extra
                            Service</button>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="specifications[body]" class="form-control" id="body"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="specifications[seats]" class="form-control" id="seats"
                                        value="5" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <button type="submit" class="mt-3 btn btn-primary">Update Car</button>
                    </form>
                </div>
            </div>
        </div>
